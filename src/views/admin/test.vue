<template>
      ...
      <div class="box d-flex">
        <div class="add-product mt-3 ms-5 shadow p-3 mb-5 bg-body rounded">
          ...
          <form action="#">
                ...
                <div class="radio-left col">
                  <div class="radio">
                    <input
                      ...
                      checked
                    />
                    <label for="" class="done">Chossure</label>
                  </div>
                  <div class="radio">
                    <input
                      type="radio"
                      ...
                      class="mx-1 mb-4"
                    />
                    <label for="" class="done">Tuishort</label>
                  </div>
                </div>
            ...
            <Button label="Save" icon="pi pi-check" class="p-button-text btn-val" @click="saveProduct" />
          </form>
        </div>
          ...
          <div class="top-second">
            <span class="title">
              <ul class="d-flex">
                ...
                <li class="p-2">
                  Nom <i class="fas fa-arrow-right-arrow-left ps-1 ms-2 dir"></i>
                </li>
                <li class="p-2 ms-3">
                  Image
                  <i class="fas fa-arrow-right-arrow-left ps-1 ms-2 dir"></i>
                </li>
                <li class="p-2">
                  Price
                  <i class="fas fa-arrow-right-arrow-left ps-1 ms-2 dir"></i>
          ...
          <div class="central">
            <div class="title">
              <ul class="d-flex">
                <input
                  type="checkbox"
                  aria-label="Checkbox for following text input lst1"
                />
  
                <li class="p-2 lst2">Code</li>
                <li class="p-2">Nom</li>
                <li class="p-2">Image</li>
                <li class="p-2">Price</li>
                <li class="p-2">Categorie</li>
  ...
  .center .title {
    border-bottom: 10px solid #ced4da !important;
  }
  .central .title ul {
    justify-content: space-between;
